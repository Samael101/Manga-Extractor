...
def get_manga_link():
    ...
    manga_user_input = input("Pleae enter manga title to download: \n")
    ...
    return search_result[user]["link"]
    #--------------------------------------------------------------------#

def get_url():
    base_url, search_url = main()
...
def download_manga():
    title_array = get_url()
    selected_chapters = get_url()
    all_files = folder_checking()
